...
buoys = {'BOLI': {'ll': ([-94.783, 29.342]), 'color': '#689F38', 'vars': ['WaterT [deg C]', 'Depth [m]', 'Salinity'], 'llshift': (-0.08, 0.02)},
         ...
         'TRIN': {'ll': ([-94.746, 29.661]),  'color': '#FFA000', 'vars': ['WaterT [deg C]', 'Depth [m]', 'Salinity'], 'llshift': (-0.02, 0.02)},
         ...
         '08077600': {'ll': ([-95.1783, 29.5172]), 'color': '#D32F2F', 'vars': ['Flow rate [m^3/s]'], 'llshift': (-0.16, -0.03)},
         '08074500': {'ll': ([-95.39694, 29.775]), 'color': '#FFA000', 'vars': ['Flow rate [m^3/s]'], 'llshift': (0.0, -0.03)},
         ...
         '08067252': {'ll': ([-94.731, 29.812]), 'color': '#388E3C', 'vars': ['Flow rate [m^3/s]'], 'llshift': (0.03, -0.01)},

         '08075730': {'ll': ([-95.21611, 29.6944]), 'color': '#FFA000', 'vars': ['Flow rate [m^3/s]'], 'llshift': (0.0, 0.01)},
         '08075605': {'ll': ([-95.2289, 29.656389]), 'color': '#FFA000', 'vars': ['Flow rate [m^3/s]'], 'llshift': (0.0, -0.03)},
         '08075400': {'ll': ([-95.445833, 29.618611]), 'color': '#FFA000', 'vars': ['Flow rate [m^3/s]'], 'llshift': (-0.16, -0.03)},
         '08075000': {'ll': ([-95.411944, 29.696944]), 'color': '#FFA000', 'vars': ['Flow rate [m^3/s]'], 'llshift': (-0.16, -0.03)},
         '08073700': {'ll': ([-95.5233, 29.7467]), 'color': '#FFA000', 'vars': ['Flow rate [m^3/s]'], 'llshift': (-0.16, -0.04)},
         '08074540': {'ll': ([-95.368056, 29.79278]), 'color': '#FFA000', 'vars': ['Flow rate [m^3/s]'], 'llshift': (-0.16, 0.02)},
         '08075770': {'ll': ([-95.2678, 29.793056]), 'color': '#FFA000', 'vars': ['Flow rate [m^3/s]'], 'llshift': (0.0, 0.02)},
         '08076500': {'ll': ([-95.334722, 29.86167]), 'color': '#FFA000', 'vars': ['Flow rate [m^3/s]'], 'llshift': (0.0, 0.02)},
         '08076000': {'ll': ([-95.3067, 29.918056]), 'color': '#FFA000', 'vars': ['Flow rate [m^3/s]'], 'llshift': (-0.16, 0.02)},
         '08076180': {'ll': ([-95.23375, 29.9336389]), 'color': '#FFA000', 'vars': ['Flow rate [m^3/s]'], 'llshift': (-0.1, 0.03)},
         '08067525': {'ll': ([-94.99944, 29.77056]), 'color': '#FFA000', 'vars': ['Flow rate [m^3/s]'], 'llshift': (0.0, 0.02)},
         '08067500': {'ll': ([-94.9856, 29.9725]), 'color': '#AFB42B', 'vars': ['Flow rate [m^3/s]'], 'llshift': (0.0, 0.02)},
         '08066500': {'ll': ([-94.85056, 30.425]), 'color': '#388E3C', 'vars': ['Flow rate [m^3/s]'], 'llshift': (0.0, 0.01)},
         '08042558': {'ll': ([-94.666114, 29.6756]), 'color': '#0288D1', 'vars': ['Flow rate [m^3/s]'], 'llshift': (0.0, 0.02)},


         '08072000': {'ll': ([-95.1411, 29.91611]), 'color': '#FFA000', 'vars': ['Gage height [m]'], 'llshift': (0.0, 0.01)},


         '08067000': {'ll': ([-94.818056, 30.0575]), 'color': '#388E3C', 'vars': ['Rain [cm]'], 'llshift': (0.03, 0)},
         '08077650': {'ll': ([-94.92, 29.4472]), 'color': '#D32F2F', 'vars': ['Rain [cm]'], 'llshift': (-0.17, -0.01)},
         '08073600': {'ll': ([-95.55750, 29.76194]), 'color': '#FFA000', 'vars': ['Rain [cm]'], 'llshift': (-0.16, 0.01)},
         ...
         '8770613': {'ll': ([bys['8770613']['lon'], bys['8770613']['lat']]),  'color': '#E64A19',
                     'vars': ['Water Level [m]', 'AirT [deg C]', 'WaterT [deg C]', 'East [m/s]', 'North [m/s]', 'Salinity'], 'llshift': (-0.02, 0.02)},
